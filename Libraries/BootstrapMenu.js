...
window.BootstrapMenu.make = function () {
    ...
    window.BootstrapSetup = function () {
        ...
        divList.style = 'width:25px;position:relative;left:230px;top:45px;font-size:14px;font-family:Roboto,Arial,sans-serif;color:white;font-size:14px;line-height: normal;'
