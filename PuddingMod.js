...
*/
  ...
  <div class="form-check form-check-inline">
    ...
    <button class="btn" style="margin:3px;color:white;background-color:#1155CC;font-family:Roboto,Arial,sans-serif;" id="TimerSettings" disabled>Timer settings</button><br>
    <div class="form-check form-check-inline">
