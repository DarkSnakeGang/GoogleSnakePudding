...
window.PuddingMod.runCodeBefore = function () {
  ...
  window.Libraries = ["Core", "Theme", "DistinctVisual", "Counter", "TimeKeeper", "Fruit", "TopBar", "SnakeColor", "InputDisplay", "CustomPortalPairs", "SpeedInfo", "SettingsSaver", "BootstrapMenu"];
